								...
								<section class="content">
									<div class="row">
										<div class="col-md-12">
											<div class="row">
												<div class="col-md-2">
													<input type="hidden" id="content_type" value="{{$app_type}}">
												...
												<div class="col-md-12">
													...
													<table class="table table-bordered table-striped" id="tb">
														...
														<tr>
															...
															<td>
																<a href="javascript:void(0);" class="remove"><i class="la la-times-circle" style="font-size: 33px;
                                                                    color: red;"></i></a>
															</td>
														</tr>
														...
														<tfoot>
															<tr>
																...
																<th>
																	<a href="javascript:void(0);" style="font-size:18px;" id="addMore" title="Add More Person"><i class="la la-plus-circle" style="font-size: 33px;
                                                                        color: blue;"></i></a>
																</th>
															</tr>
														</tfoot>
